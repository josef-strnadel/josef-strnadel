...
- 👀 I’m **interested in** (but not limited to):
  ...
  - microcontrollers; e.g., those based on ARM, ESPx, MSPx, STMx, HC(S)08, ...
  - real-time (operating) systems; baremetal or using e.g., FreeRTOS, uC/OS-II(I), Mbed, MQX, ...
  ...
  - modeling & analysis of systems and formal verification & model checking, statistical model checking in UPPAAL, ...
